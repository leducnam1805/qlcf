  ...
  <!-- sua -->
      ...
      <%
       		if(request.getAttribute("catUser") != null){
       			...
       			%>
       	<form role="form" id="registration" action="<%=request.getContextPath()%>/admin/user/cat/edit" method="post">
	       	<div class="form-group row">
			    <label for="exampleprice" class="col-sm-3">Cập nhật loại tài khoản</label>
			    <input type="hidden" class="form-control col-sm-8" id="exampleprice" value="<%=catUser.getId()%>" name="idCatUser">
			    <input type="text" class="form-control col-sm-8" id="exampleprice" value="<%=catUser.getName()%>" name="nameCreate">
			  </div>
