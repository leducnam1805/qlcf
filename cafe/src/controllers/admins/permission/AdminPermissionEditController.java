...
public class AdminPermissionEditController extends HttpServlet {
	...
	public AdminPermissionEditController() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Permission permission = new Permission(0, new CatUser(perID),false , giatri, false);
		int editPer = permissionDAO.editPer(permission);
		if(editPer > 0) {
